...
export function NewsletterBlock() {
  ...
  return (
    <section className="mx-auto max-w-page px-gutter pb-[clamp(76px,9vw,132px)]">
      <Reveal className="grid items-center gap-[clamp(28px,5vw,64px)] rounded-2xl border border-line-1 bg-bg-2 p-5 shadow-lg sm:p-[clamp(28px,4vw,56px)] md:rounded-3xl md:shadow-xl lg:grid-cols-[1fr_0.9fr]">
        <div>
