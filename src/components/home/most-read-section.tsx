...
import { getPopularPosts, routes, site } from "@/lib/content";
  ...
  return (
    <section className="mx-auto max-w-page px-gutter pb-tail">
      <div className="grid items-start gap-[clamp(28px,4vw,56px)] lg:grid-cols-[1fr_380px]">
        ...
        <Reveal className="relative overflow-hidden rounded-xl bg-bg-inverse p-8.5">
          <div
            aria-hidden
          ...
          <div className="relative">
            ...
            <h3 className="mt-4 text-[28px] leading-[1.15] font-light tracking-[-0.02em] text-white">
            ...
            <div className="mt-6.5 grid grid-cols-2 gap-3">
              <ArchiveStat value={site.issue} label="Posts published" />
              <ArchiveStat value={site.correctionCount} label="Corrections issued" />
            </div>

            <Link
              href={routes.articles}
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-5.5 py-[13px] text-[14.5px] font-semibold text-n-900 transition-[transform,box-shadow] duration-[350ms] ease-bounce hover:-translate-y-0.5 hover:shadow-lg active:scale-[0.96] active:duration-150 active:ease-out"
            >
              Open the archive
