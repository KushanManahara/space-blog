  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "glass-panel fixed left-1/2 z-50 max-h-[90vh] w-[calc(100%-24px)] [translate:var(--dialog-tx)_var(--dialog-ty)] overflow-auto rounded-lg outline-none data-[state=closed]:[animation:pop-out_.15s_ease-in] data-[state=open]:[animation:pop-in_.26s_var(--ease-bounce)] sm:w-[calc(100%-40px)]",
          align === "top"
